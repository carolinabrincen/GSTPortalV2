export class SumaTotalE{
    sumaTotalCE: number = 0;
    sumaTotalTE: number = 0;
    sumaTotalGE: number = 0;
    sumaTotalHE: number = 0;
...
export class SumaTotalF{
    ...
    sumaTotalGF: number = 0;
    sumaTotalHF: number = 0;
...
export class SumaTotalM{
    ...
    sumaTotalGM: number = 0;
    sumaTotalHM: number = 0;
...
export class SumaTotalA{
    ...
    sumaTotalGA: number = 0;
    sumaTotalHA: number = 0;

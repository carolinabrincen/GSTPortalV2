...
export class AnticiposService extends AbstractManagerService {
  ...
  getAnticipos(operador: any){
    return this.get<any>((this.API_URL + API_URLS.GET_ANTICIPOS+operador), this.httpOptions);
  }

  getOperador(value){
    return this.post<any>((this.API_URL + API_URLS.POST_OPERADOR),value, this.httpOptions);
  }

...
@Component({
  templateUrl: './documentacionOperador.component.html',
  styleUrls: ['./documentacionOperador.component.scss'],
  providers: [UnidadesService, ServiceSales, CurrencyPipe, Service],
})

export class DocumentacionOperadorComponent implements OnInit {

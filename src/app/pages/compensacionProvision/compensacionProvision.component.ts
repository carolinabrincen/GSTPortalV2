...
@Component({
  templateUrl: './compensacionProvision.component.html',
  styleUrls: ['./compensacionProvision.component.scss'],
})
export class CompensacionProvisionComponent implements OnInit {
  ...
  udn = [
    {id: 0, ciudad: 'TODOS'},
    {id: 1, ciudad: 'ORIZABA'},
    {id: 2, ciudad: 'GUADALAJARA'},
    {id: 3, ciudad: 'RAMOS ARIZPE'},
    {id: 4, ciudad: 'MEXICALI'},
    {id: 5, ciudad: 'HERMOSILLO'},
    {id: 8, ciudad: 'CUAUTITLAN'},
    {id: 9, ciudad: 'TULTITLAN'},
  ]
  ...
  tipo = [
    {id:0, descripcion: 'Flete'},
    {id:1, descripcion: 'Otros Ingresos'},
  ]
